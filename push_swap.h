...
/*   Updated: 2017/02/09 15:12:04 by tlenglin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef int		(*t_fct)(t_stack*);
typedef int		(*t_fct_bis)(int, t_stack*);
...
int				ft_realloc_string_bis(t_stack *stack, char **tmp, int *j,
	int *i);
